...
$conn2 = new mysqli("localhost", "root", "", "saung_bahagia"); // Ubah sesuai nama database yang benar
...
while ($row = $result->fetch_assoc()) {
    ...
    if (empty($namaProduk)) {
        echo "Produk dengan nama kosong dilewati.<br>";
        continue; // Lewati produk dengan nama kosong
    }
    ...
    if ($cek->num_rows == 0) {
        ...
        if (!$insert) {
            ...
            echo "Produk '$namaProduk' berhasil disinkronkan.<br>";
        }
    } else {
